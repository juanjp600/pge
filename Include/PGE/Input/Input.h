...
class MouseInput : public Input {
    public:
        ...
        MouseInput(MouseButton mouseButton) : mouseButton(mouseButton) { }
...
class ControllerInput : public Input {
    public:
        ...
        ControllerInput(Controller* ctrlr, ControllerButton inControllerButton, float threshold = 0.5f);

    private:
        const Controller* controller;
        const ControllerButton controllerButton;
